with
    ...
    joined as (
        -- Select order_id, customer_id, ordered_at, order_status, total_amount and
        -- store_id from orders
        -- Calculate delivery_time_from_order as datediff (in minutes) between
        -- ordered_at (orders) and delivered_at (deliveries_filtered)
        -- Calculate delivery_time_from_collection as datediff (in minutes) between
        -- picked_up_at (deliveries_filtered) and delivered_at (deliveries_filtered)
